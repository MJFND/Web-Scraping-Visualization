...
https://mikepultz.com/2013/06/mining-twitter-api-v1-1-streams-from-php-with-oauth/

Modified by: Junaid Effendi 
*/
...
class ctwitter_stream
{
    ...
    {   
		$msg = utf8_encode($_data);
		// Formating dat for EventStream JavaScript (Front End) library
                    ...
                    if ( ($json !== false) && (strlen($json) > 0) )
                    {
                       ...
                       $data = json_decode($json, true);
                        ...
                        {						
                            ...
                            // If the tweet is null donot pocess it
							if($myObj->text != null)
